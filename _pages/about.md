...
My primary research interest lies at the intersection of **synthetic biology** and **toxicology**, with applications in **aging medicine**. I focus on developing safe synthetic biology products through **Safety by Design** approaches, combining computational prediction and experimental validation. 

I am particularly interested in applying **computational biology** approaches to explore which natural or synthetic compounds may be beneficial or harmful to biological systems. While I have worked extensively with _Caenorhabditis elegans_, I view it as one of several useful model organisms—including cultured cells and other systems—for understanding the biological effects of candidate compounds. Beyond phenotypic screening, I am also interested in uncovering the underlying **molecular mechanisms** that mediate these effects.

**Current Project**: I am participating in toxicity assessment testing for **D-allulose**, a food ingredient produced through synthetic biology cell factories. This project, supported by the Beijing government, aims to evaluate the safety profile of this synthetic biology-derived product for market approval.
...
- **Synthetic biology** product safety assessment
